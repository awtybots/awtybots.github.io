Today was a messy day, but in a good way. We started building the practice robot.

# Drive

- The programming team managed to fix the drifting issues with the drive. They are ready to start tuning autos, but we took the drive base away from them because we started building the practice robot. We could have just used new swerve modules but we hopefully should just finish everything by this Saturday so they can have a complete robot by then.
